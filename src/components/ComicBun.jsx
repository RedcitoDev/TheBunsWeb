    ...
    <>
        <section className='py-20'>
            ...
            <div className='xl:flex justify-center md:mx-30'>
                ...
                <img className='relative hidden xl:flex z-20 xl:w-[40%] w-[60%] h-auto hover:scale-105 duration-300 ease-in-out pb-40' src={Book} alt="" />
                <div className='relative z-20 flex-nowrap xl:bg-transparent'>
                    ...
                    <div className='flex justify-center'>
                        <a className='hover:scale-105 duration-300 ease-in-out flex items-center border-2 px-5 py-2 rounded-full hover:bg-[#fb592f]' href="https://discord.gg/vinylverse"><img className='w-10 pr-2' src={DiscordIcon} alt="" /> <span className=' font-bold text-white'>Click here</span></a>
                    </div>
